      ...
      <View style={[tw`w-full h-[220px] relative`]}>
        ...
        <View style={[tw`flex-row justify-between items-center px-5 mt-2`]}>
          ...
          <View style={[tw`flex-row items-center space-x-2`]}>
            <Icon name="location-on" size={25} style={[tw`text-yellow-700`]} />
            <Text style={[tw`text-md text-white text-base font-semibold`]}>
              Karachi, Pakistan
            </Text>
          </View>
          <Icon name="notifications" size={35} style={[tw`text-yellow-700`]} />
        </View>
        ...
        <View style={[tw`mx-4 mt-18`]}>
          <View
            ...
            <TouchableOpacity
              style={[
                tw`p-3 m-1 rounded-full bg-yellow-700`]}>
      ...
      <FlatList 
        ...
        renderItem={({ item }) => {
          ...
          return (
            ...
            >
              <Text style={[tw`font-semibold text-white`]}>{item.title}</Text>
            </TouchableOpacity>
          );
        }}
      />
